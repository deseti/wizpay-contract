...
/**
 * Send 0.5 EURC to Address 
 * Real ARC Testnet
 */
async function main() {
    console.log("╔════════════════════════════════════════════════════════════════╗");
    console.log("║  Send 0.5 EURC → USDC to 0xef6582d8bd8c5e6f1ca37181b4b6284c945b3484 ║");
    console.log("╚════════════════════════════════════════════════════════════════╝\n");
    ...
    // ============================================================
    // Step 2: Approve 0.5 EURC
    // ============================================================
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("Step 2: Approve 0.5 EURC to WizPay");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log();
    ...
    try {
        ...
        const approveAmount = hre.ethers.parseUnits("0.5", 6);
        console.log("Approving 0.5 EURC...");
    ...
    // ============================================================
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("Step 3: Execute Payment - 0.5 EURC to Recipient");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log();
    ...
    try {
        ...
        const amountIn = hre.ethers.parseUnits("0.5", 6);
        const minOut = 0n;
        const expectedOutput = (rate * 0.5).toFixed(4);

        console.log("Payment Details:");
        console.log("  From: " + deployer.address);
        console.log("  To: " + RECIPIENT);
        console.log("  Input: 0.5 EURC");
        ...
        console.log("╔════════════════════════════════════════════════════════════════╗");
        console.log("║  ✅ SUCCESS - 0.5 EURC sent as USDC to recipient             ║");
        console.log("║                                                                ║");
        console.log("║  Recipient: " + RECIPIENT + "  ║");
        console.log("║  Amount: 0.5 EURC → ~" + expectedOutput + " USDC                            ║");
