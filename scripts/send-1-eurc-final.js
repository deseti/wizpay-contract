...
/**
 * Send 1 EURC to Address - Direct Payment (No Pre-funding)
 * Real ARC Testnet
 */
async function main() {
    console.log("╔════════════════════════════════════════════════════════════════╗");
    console.log("║  Send 1 EURC → USDC to 0xef6582d8bd8c5e6f1ca37181b4b6284c945b3484 ║");
    console.log("║  (Adapter already has liquidity)                               ║");
    console.log("╚════════════════════════════════════════════════════════════════╝\n");
    ...
    // ============================================================
    // Step 2: Approve 1 EURC
    // ============================================================
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("Step 2: Approve 1 EURC to WizPay");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log();
    ...
    // ============================================================
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("Step 3: Execute Payment - 1 EURC to Recipient");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log();
    ...
    try {
        ...
        const minOut = 0n; // Let adapter handle slippage internally
        ...
        console.log("  Min Output: 0 (let adapter handle)");
        console.log();
        ...
        console.error("Error:", err.message);
        console.error("\nTroubleshooting:");
        console.error("- Check if adapter has sufficient USDC liquidity");
        console.error("- Verify exchange rate was updated");
        console.error("- Check if recipient address is valid");
        process.exit(1);
    }
}
